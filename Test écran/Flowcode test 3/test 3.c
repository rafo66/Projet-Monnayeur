//************************************************************************************
//**  
//**  Source name:   C:\Users\USERX\OneDrive - Conseil régional Grand Est - Numérique Educatif\Lycée\Terminale\2I2D\Projet\Test écran\Flowcode test 3\test 3.fcfx
//**  Title:         
//**  Description:   
//**  Device:        PIC.16F.16F877A
//**  
//**  Generated by:  Flowcode v8.2.2.15
//**  Date:          Thursday, April 13, 2023 15:08:44
//**  Users:         1
...
void FCD_0a2b1_gLCD_ILI9341_SPI1__Initialise()
{
	...
	FCV_0a2b1_gLCD_ILI9341_SPI1__FOREGROUND_COL_VAR = 0;
	FCV_0a2b1_gLCD_ILI9341_SPI1__BACKGROUND_COL_VAR = 65535;
...
OPTION_REG = 0xC0;
	...
	// Name: Call Component Macro, Type: Call Component Macro: gLCD_ILI9341_SPI1::SetDisplayOrientation(2)
	FCD_0a2b1_gLCD_ILI9341_SPI1__SetDisplayOrientation(2);

	// Name: Call Component Macro, Type: Call Component Macro: gLCD_ILI9341_SPI1::SetBackgroundColour(210, 200, 190)
	FCD_0a2b1_gLCD_ILI9341_SPI1__SetBackgroundColour(210, 200, 190);

	// Name: Call Component Macro, Type: Call Component Macro: gLCD_ILI9341_SPI1::ClearDisplay()
	FCD_0a2b1_gLCD_ILI9341_SPI1__ClearDisplay();

	// Name: Call Component Macro, Type: Call Component Macro: gLCD_ILI9341_SPI1::DrawRectangle(0, 0, 239, 319, 0, 0)
	FCD_0a2b1_gLCD_ILI9341_SPI1__DrawRectangle(0, 0, 239, 319, 0, 0);

	// Name: Call Component Macro, Type: Call Component Macro: gLCD_ILI9341_SPI1::Print("Ca marche :)", 30, 50, 2, 0)
	FCD_0a2b1_gLCD_ILI9341_SPI1__Print("Ca marche :)", 13, 30, 50, 2, 0);
